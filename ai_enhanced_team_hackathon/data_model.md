...
image_21.png dosyasındaki **Relationships** (Task için), **4. Comment** ve ilişkili bölümlerin Markdown kodu aşağıdadır:
```markdown
**Relationships:**
...
image_23.png dosyasındaki **Join Tables** ve **Entity Relationship Diagram (Text)** bölümlerinin Markdown kodu aşağıdadır:
```markdown
## Join Tables
